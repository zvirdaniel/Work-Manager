...
class ExportDialogController : Initializable {
	...
	/**
	 * Initializes a listener to the "single month" checkbox which changes the interface respectively
	 */
	 ...
	 * Converts the user interface elements into a Pair<IntRange, File?> with the results
	 */
	...
	/**
	 * Creates a choice box and sets it into an anchor pane
	 */
